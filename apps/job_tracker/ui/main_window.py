...
class ComposeDialog(QDialog):
    ...
    def _ai_gen(self):
        ...
        intro = generate_personalized_intro(self._app.get("company",""), self._app.get("notes",""))
        self.bodyField.setPlainText(build_email_body(self._app.get("company",""), intro))
        self.subjField.setText(
            f"Exploring {self._app.get('position','product')} opportunities at {self._app.get('company','your company')}"
        )
